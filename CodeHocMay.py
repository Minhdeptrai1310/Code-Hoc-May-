...
lable_ten = Label(form, text = "Nhập thông tin cho siêu xe :", font=("Arial Bold", 10), fg="red")
...
lable_doors = Label(form, text = "Số cửa:")
...
lable_lug_boot = Label(form, text = "Không gian cốp:")
